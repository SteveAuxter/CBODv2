...
<body>
    ...
    <?php try {
        ...
        // SQL query to retrieve MODELS and count distinct devices
        $sql = "SELECT model, COUNT(DISTINCT deviceId) AS device_count FROM devices GROUP BY model ORDER BY model";
        $result = $db->query($sql);
