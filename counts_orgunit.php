...
<body>
    ...
    <?php try {
        ...
        // SQL query to retrieve ORGUNITS and count distinct devices
        $sql = "SELECT orgUnitPath, COUNT(DISTINCT deviceId) AS device_count FROM devices GROUP BY orgUnitPath ORDER BY orgUnitPath";
        $result = $db->query($sql);
        ...
        while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
            echo "<tr>";
            echo "<td>" . htmlspecialchars($row['orgUnitPath']) . "</td>";
