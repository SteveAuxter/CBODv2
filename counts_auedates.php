...
<body>
    ...
    <ul class="menu">
        ...
        <li><a class="active" href="counts_auedates.php">AUE Dates</a></li>
    </ul>
    <hr>
    ...
    <?php try {
        ...
        // SQL query to retrieve AUE DATES and count distinct devices
        $sql = "SELECT autoUpdateExpiration, model, COUNT(DISTINCT deviceId) AS device_count FROM devices GROUP BY model ORDER BY autoUpdateExpiration";
        $result = $db->query($sql);
        ...
        while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
            echo "<tr>";
            echo "<td>" . htmlspecialchars($row['autoUpdateExpiration']) . "</td>";
