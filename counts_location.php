...
<body>
    ...
    <?php try {
        ...
        // SQL query to retrieve LOCATION and count distinct devices
        $sql = "SELECT annotatedLocation, COUNT(DISTINCT deviceId) AS device_count FROM devices GROUP BY annotatedLocation ORDER BY annotatedLocation";
        $result = $db->query($sql);
