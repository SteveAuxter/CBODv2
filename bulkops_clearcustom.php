    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($dataType) && !empty($inputData)) {
            ...
            $commands = array_map(function($data) use ($dataType) {
                switch ($dataType) {
                    case "device_id":
                    return "gam cros " . $data . " update user \"\" notes \"\" assetid \"\" location \"\"";
                    case "serial_number":
                    return "gam cros_sn " . $data . " update user \"\" notes \"\" assetid \"\" location \"\"";
                    case "asset_id":
                    return "gam cros_query asset_id:" . $data . " update user \"\" notes \"\" assetid \"\" location \"\"";
                    default:
